        ...
        <div className="space-y-16 text-dark/80 font-light leading-[1.7]">
          ...
          <section>
            ...
            <ul className="space-y-2">
              <li className="p-4 rounded-xl bg-white border border-dark/5 text-sm">Bir sözleşmenin kurulması veya ifasıyla doğrudan doğruya ilgili olması.</li>
              <li className="p-4 rounded-xl bg-white border border-dark/5 text-sm">İlgili kişinin temel hak ve özgürlüklerine zarar vermemek kaydıyla meşru menfaatlerimiz için zorunlu olması.</li>
              <li className="p-4 rounded-xl bg-white border border-dark/5 text-sm">Pazarlama iletişimleri için açık rızanızın bulunması.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <div className="flex flex-wrap gap-4">
              <div className="px-5 py-3 rounded-full bg-dark/5 text-sm font-medium">SSL Şifreleme</div>
              <div className="px-5 py-3 rounded-full bg-dark/5 text-sm font-medium">Güvenli Veri Tabanı Mimarisi</div>
              <div className="px-5 py-3 rounded-full bg-dark/5 text-sm font-medium">Erişim Yetki Sınırlandırmaları</div>
            </div>
          </section>
          ...
          <section>
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
              <li className="flex items-start gap-2"><div className="w-1.5 h-1.5 rounded-full bg-dark mt-1.5"></div> Verilerinizin işlenip işlenmediğini öğrenme.</li>
              <li className="flex items-start gap-2"><div className="w-1.5 h-1.5 rounded-full bg-dark mt-1.5"></div> Verileriniz işlenmişse bilgi talep etme.</li>
              <li className="flex items-start gap-2"><div className="w-1.5 h-1.5 rounded-full bg-dark mt-1.5"></div> İşlenme amacını ve uygun kullanımını öğrenme.</li>
              <li className="flex items-start gap-2"><div className="w-1.5 h-1.5 rounded-full bg-dark mt-1.5"></div> Yurt içi/yurt dışı aktarılan üçüncü kişileri bilme.</li>
              <li className="flex items-start gap-2"><div className="w-1.5 h-1.5 rounded-full bg-dark mt-1.5"></div> Eksik/yanlış işlenmişse düzeltilmesini isteme.</li>
              <li className="flex items-start gap-2"><div className="w-1.5 h-1.5 rounded-full bg-dark mt-1.5"></div> Kanuni şartlar dahilinde silinmesini isteme.</li>
              <li className="flex items-start gap-2"><div className="w-1.5 h-1.5 rounded-full bg-dark mt-1.5"></div> Otomatik sistemler aleyhinize sonuç doğuruyorsa itiraz etme.</li>
            </ul>
          </section>
