      ...
      <div className="container-app ">
            ...
            >
              <Link to={`/${lang}/projects/${project.id}`} className="block relative aspect-[4/3] rounded-3xl overflow-hidden bg-white/5 border border-white/10 mb-6">
                <img 
                  ...
                  loading="lazy"
                />
                <div className="absolute inset-0 bg-dark/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center backdrop-blur-[2px]">
                   <span className="bg-pink text-white px-6 py-3 rounded-full text-sm font-bold shadow-xl shadow-pink/30 flex items-center gap-2 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300">
        ...
        <div className="mt-24 text-center pt-16 border-t border-white/10">
           ...
           <a 
             ...
             className="inline-flex items-center gap-2 rounded-full bg-white text-dark px-8 py-4 text-sm font-bold transition-all hover:bg-pink hover:text-white"
           >
