    ...
    <div className="bg-[#FDFBF8] w-full mt-[-80px] pt-20">
      ...
      <section className="relative overflow-hidden pt-32 pb-24 md:pt-40 md:pb-32 px-6">
        ...
        <div className="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80">
          <motion.div
            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-pink/20 to-purple/20 opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            animate={{ rotate: 360 }}
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-dark/5 shadow-sm text-xs font-bold uppercase tracking-widest text-dark/50 mb-8">
              <span className="w-2 h-2 rounded-full bg-[#ca006c]"></span>
              UX.IPEK SERVICES
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a href="https://calendly.com/ipekbolakca/dijital-urun-yazilim-cozumleri-uzerine" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto flex items-center justify-center gap-3 rounded-2xl bg-[#1E293B] px-8 py-4 text-sm font-bold text-white transition-all shadow-[0_8px_30px_rgb(30,41,59,0.2)] hover:shadow-[0_8px_40px_rgb(30,41,59,0.4)] hover:-translate-y-1">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              className="group flex flex-col justify-between rounded-[2rem] bg-[#FDFBF8] p-10 transition-all hover:-translate-y-1 hover:shadow-xl border border-dark/5 hover:border-[#ca006c]/20"
            >
              <div>
                <div className="mb-8 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-white text-dark shadow-sm transition-transform duration-500 group-hover:scale-105 group-hover:text-[#ca006c]">
                  <Search className="h-6 w-6 stroke-[1.5]" />
                </div>
                <h3 className="mb-4 text-2xl font-medium text-dark">{lang === 'en' ? 'UX & Conversion Strategy' : 'UX & Dönüşüm Stratejisi'}</h3>
                <p className="font-light leading-relaxed text-dark/70 mb-8">
                  {lang === 'en' 
                ...
                <ul className="space-y-3 mb-8">
                  {['UX Audits', 'Behavioral UX', 'CRO Optimization'].map((item, i) => (
                    <li key={i} className="flex items-center gap-3 text-sm font-medium text-dark/80">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#ca006c]"></span>
                      {item}
                    </li>
                  ))}
                </ul>
            ...
            <motion.div 
              ...
              className="group flex flex-col justify-between rounded-[2rem] bg-[#1E293B] text-white p-10 transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-[#1E293B]/20"
            >
              <div>
                <div className="mb-8 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-white/10 backdrop-blur-md text-white transition-transform duration-500 group-hover:scale-105 group-hover:bg-white group-hover:text-[#1E293B]">
            ...
            <motion.div 
              ...
              className="group flex flex-col justify-between rounded-[2rem] bg-[#FDFBF8] p-10 transition-all hover:-translate-y-1 hover:shadow-xl border border-dark/5 hover:border-purple/20"
            >
              <div>
                <div className="mb-8 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-white text-dark shadow-sm transition-transform duration-500 group-hover:scale-105 group-hover:text-purple">
                  <LineChart className="h-6 w-6 stroke-[1.5]" />
                </div>
                <h3 className="mb-4 text-2xl font-medium text-dark">{lang === 'en' ? 'Landing Pages & Growth Funnels' : 'Açılış Sayfaları ve Büyüme Hunileri'}</h3>
                <p className="font-light leading-relaxed text-dark/70 mb-8">
                  {lang === 'en'
      ...
      <section className="px-6 py-32 bg-white text-center">
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <a href="https://calendly.com/ipekbolakca/dijital-urun-yazilim-cozumleri-uzerine" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-3 rounded-2xl bg-[#ca006c] px-10 py-5 text-base font-bold text-white transition-all shadow-lg hover:-translate-y-1 hover:shadow-xl hover:bg-[#ca006c]/90 mt-8">
